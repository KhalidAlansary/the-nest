        ...
        <div className="container mx-auto">
          <div className="mb-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-nest-dark">
                  {property.name}
                </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2">
              <div className="mb-8">
                <h2 className="text-2xl font-bold mb-2 text-nest-dark">
                  About this property
                </h2>
              ...
              <div className="mb-8">
                <h2 className="text-2xl font-bold mb-4 text-nest-dark">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200 sticky top-20">
                <div className="mb-6">
                  <div className="flex justify-between items-center mb-2">
                    <h3 className="text-xl font-bold text-nest-dark">
                      Pricing Options
                    </h3>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-4">
                    <Button
                      ...
                      className={
                        selectedTab === "day"
                          ? "bg-nest-primary hover:bg-nest-primary/90"
                          : ""
                      }
