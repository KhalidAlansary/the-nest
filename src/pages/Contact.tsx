        ...
        <section className="bg-nest-accent text-white py-16 md:py-24">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              Have questions or need assistance? We're here to help you find your perfect nest.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-8">
                  ...
                  need help with a booking, or are interested in listing your property with us, 
                ...
                <form className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <label htmlFor="privacy" className="text-sm text-gray-700">
                      I agree to the <a href="#" className="text-nest-primary hover:underline">privacy policy</a> and consent to be contacted regarding my inquiry.
                    </label>
                  </div>
