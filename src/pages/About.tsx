        ...
        <section className="bg-nest-accent text-white py-16 md:py-24">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              We're on a mission to make finding your temporary home as simple
              and enjoyable as possible, whether you need it for a day, a week,
              or a month.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  quality rentals has grown into a comprehensive service
                  offering daily, weekly, and monthly rental options across
                  major cities nationwide.
                </p>
                <p className="text-gray-700">
                  Today, The Nest helps thousands of guests find their perfect
                  temporary home, while enabling property owners to maximize the
                  value of their real estate investments with flexible rental
                  options.
                </p>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-700 max-w-3xl mx-auto">
                At The Nest, we're guided by a set of core values that inform
                everything we do.
              </p>
            </div>
              ...
              {[
                {
                  title: "Quality & Trust",
                  description:
                    "We carefully vet all properties to ensure they meet our high standards for quality, comfort, and safety.",
                },
                {
                  title: "Flexibility",
                  description:
                    "We understand that everyone's needs are different, which is why we offer flexible rental durations to suit your schedule.",
                },
                {
                  title: "Transparency",
                  description:
                    "No hidden fees or surprises. We believe in clear, honest communication with our guests and property owners.",
                },
                {
                  title: "Customer Service",
                  description:
                    "Our dedicated support team is available 24/7 to assist with any questions or issues that may arise.",
                },
                {
                  title: "Innovation",
                  description:
                    "We continuously improve our platform to make finding and booking your rental as seamless as possible.",
                },
                {
                  title: "Community",
                  description:
                    "We're building a community of guests and hosts who share our vision of a better rental experience.",
                },
              ].map((value, index) => (
        ...
        <section className="section-padding">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-700 max-w-3xl mx-auto">
                The passionate individuals behind The Nest who work tirelessly
                to provide you with the best rental experience.
              </p>
            </div>
              ...
              {teamMembers.map((member) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-nest-primary font-medium mb-3">
                      {member.role}
                    </p>
