...
const properties = [
  ...
  },
  {
    ...
    rating: 4.8,
    image:
      "https://images.unsplash.com/photo-1613490493576-7fde63acd811?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8dmlsbGF8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60",
  },
  {
    id: 3,
    ...
    rating: 4.7,
    image:
      "https://images.unsplash.com/photo-1536376072261-38c75010e6c9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDV8fGxvZnR8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60",
  },
];
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {properties.map((property) => (
            <div
              key={property.id}
              className="property-card bg-white rounded-lg overflow-hidden shadow-md"
            >
              {/* Property Image */}
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-2xl font-bold text-nest-accent">
                      {property.price}
                    </span>
                    <span className="text-gray-600 text-sm">
                      {" "}
                  ...
                  <Button
                    variant="outline"
                    className="border-nest-primary text-nest-primary hover:bg-nest-primary hover:text-white"
                    asChild
                  >
