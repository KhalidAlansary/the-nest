...
export const propertySubmissions: PropertySubmission[] = [
  {
    ...
    description: "Stunning beachfront condo with panoramic ocean views, perfect for a relaxing getaway.",
    owner: {
      id: 2,
      name: "Jane Smith",
  ...
  },
  {
    ...
    description: "Cozy cabin nestled in the mountains, perfect for nature lovers and hikers.",
    owner: {
      id: 3,
      name: "Mark Johnson",
