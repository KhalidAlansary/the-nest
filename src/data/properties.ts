...
export const properties: Property[] = [
  {
    ...
    description:
      "A beautiful beachfront property with stunning ocean views. Perfect for family vacations or romantic getaways. This luxury villa offers direct beach access and is located just minutes from local restaurants and attractions. Enjoy breathtaking sunsets from your private patio.",
    owner: {
      id: 101,
      name: "Sarah Johnson",
      avatar:
  ...
  },
  {
    ...
    name: "Mountain Cabin",
    description:
      "Cozy cabin nestled in the mountains with breathtaking views. This rustic yet modern retreat is the perfect place to disconnect and enjoy nature. Featuring a wood-burning fireplace, fully-equipped kitchen, and panoramic mountain views from the wraparound deck.",
    owner: {
      id: 102,
  ...
  },
  {
    ...
    name: "Urban Loft",
    description:
      "Modern loft in the heart of downtown. This stylish urban retreat features exposed brick walls, high ceilings, and floor-to-ceiling windows. Located in the city's vibrant cultural district, you'll be steps away from top restaurants, museums, and entertainment venues.",
    owner: {
      id: 103,
      name: "Emma Chen",
      avatar:
        "https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80",
    },
    images: [
      {
        id: 3001,
